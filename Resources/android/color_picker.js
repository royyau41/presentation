...
function hueToRgb(m1, m2, hue) {
    ...
    v = 1 > 6 * hue ? m1 + (m2 - m1) * hue * 6 : 1 > 2 * hue ? m2 : 2 > 3 * hue ? m1 + (m2 - m1) * (2 / 3 - hue) * 6 : m1;
    return 255 * v;
}
...
exports.createColorPicker = function(params) {
    ...
    var _return = Ti.UI.createView({
        height: params.height || Ti.UI.FILL,
        width: params.width || Ti.UI.FILL
    });
    var HSLImage = Titanium.UI.createImageView({
        image: "/colorPicker/color.png",
