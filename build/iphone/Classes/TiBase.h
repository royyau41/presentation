...
// in simulator we redefine to format for presentation Developer console
...
{\
	NSString * exceptionName = [@"org.presentation." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.presentation";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIpresentationNativeItemNone = -1, 
	UIpresentationNativeItemSpinner = -2,
	UIpresentationNativeItemProgressBar = -3,
	
	UIpresentationNativeItemSlider = -4,
	UIpresentationNativeItemSwitch = -5,
	UIpresentationNativeItemMultiButton = -6,
	UIpresentationNativeItemSegmented = -7,
	
	UIpresentationNativeItemTextView = -8,
	UIpresentationNativeItemTextField = -9,
	UIpresentationNativeItemSearchBar = -10,
	
	UIpresentationNativeItemPicker = -11,
	UIpresentationNativeItemDatePicker = -12,
	
	UIpresentationNativeItemInfoLight = -13,
	UIpresentationNativeItemInfoDark = -14,
	
	UIpresentationNativeItemDisclosure = -15,
	
	UIpresentationNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all presentation instances of
