...
@interface presentationObject : KrollCoverageObject {
#else
@interface presentationObject : KrollObject {
#endif
@private
...
extern NSString * presentation$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	presentationObject *_presentation;
    KrollObject* console;
	BOOL shutdown;
