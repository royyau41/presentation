...
//Rare exceptions to indicate a bug in the _presentation code (Eg, function that a subclass should have implemented)
...
/**
 The base class for presentation proxies.
 */
