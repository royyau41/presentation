...
/**
 Base class for all presentation views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the presentation view hierarchy (such as wrapped iOS UIViews) was touched.
